...
public class SummaryTest {
    ...
    public void testGetPieChartDataAllSuccess() {
        ...
        subSummary1.setUrlName("fred");
        subSummary1.setProject(project);
        subSummary1.setSummaryType(SummaryType.SCENARIO);
        PerformanceEntry entry1 = new PerformanceEntry();
        entry1.setBuildNumber(1);
        entry1.setElapsedTime(5000000000l);
        entry1.setPassed(true);
        ...
        subSummary2.setSummaryType(SummaryType.SCENARIO);
        ...
        projectSummary.setUrlName("bill");
        String url1 = project.getUrl() + projectSummary.getUrlName() + "/" + projectSummary.getSummaryType().getSubLink() + "/" + subSummary1.getPageLink();
        String url2 = project.getUrl() + projectSummary.getUrlName() + "/" + projectSummary.getSummaryType().getSubLink() + "/" + subSummary2.getPageLink();
        String expectedReturn = "[{\"name\":\"subSummary 1 Name\",\"y\":5,\"url\":\"" + url1 + "\"},{\"name\":\"subSummary 2 Name\",\"y\":7,\"url\":\"" + url2 + "\"}]";
        org.junit.Assert.assertEquals(expectedReturn, projectSummary.getPieChartData());
    }

    @Test
    public void testGetPieChartDataNoSubSummaries() {
        PowerMockito.when(project.getUrl()).thenReturn("dummyUrl/");
        projectSummary.setSummaryType(SummaryType.FEATURE);
        projectSummary.setProject(project);
        projectSummary.setUrlName("bill");
